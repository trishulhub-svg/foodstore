    ...
    >
      ...
      <div className="relative aspect-square bg-gradient-to-br from-orange-50 to-amber-50 overflow-hidden">
        ...
        {product.stock <= 5 && product.stock > 0 && (
          <div className="absolute bottom-2 left-2 text-[10px] bg-red-500 text-white px-2 py-0.5 rounded-full">
              ...
              {quantity === 0 ? (
                ...
                <div className="flex items-center gap-0.5 bg-orange-50 rounded-xl px-1 py-0.5">
                  ...
                  <motion.span
                    ...
                    initial={{ scale: 1.5 }}
                    animate={{ scale: 1 }}
                    className="text-sm font-bold text-orange-600 min-w-[20px] text-center"
                  >
                    {quantity}
                  </motion.span>
                  <motion.button
